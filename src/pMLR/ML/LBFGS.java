...
import org.pMLR.ML.LBFGS;

/**
 *  The following is a modified version of the JAVA translation of the LBFGS optimization routine written by Robert Dodier.
...
public class LBFGS
{
	...
	public void lbfgs ( int n , int m , double[] x , double f , double[] g , boolean diagco , double[] diag , int[] iprint , double eps , double xtol , int[] iflag ) throws ExceptionWithIflag
	{
		...
		while ( true )
		{
			...
			gcm.mcsrch ( n , x , f , g , w , ispt + point * n , stp , ftol , xtol , maxfev , info , nfev , diag , gtol , stpmin , stpmax );
